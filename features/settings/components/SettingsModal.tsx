...
import { Settings, Database, Keyboard, Trash2, AlertTriangle, HelpCircle, LayoutGrid, MousePointerClick, Zap, History } from 'lucide-react';
...
type Tab = 'general' | 'data' | 'shortcuts' | 'help';
                            ...
                            <section className="space-y-3">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                                    ...
                                    <div className="p-3 rounded-xl bg-blue-50 dark:bg-blue-500/10 border border-blue-100 dark:border-blue-500/20">
                                        <div className="font-bold text-blue-600 dark:text-blue-400 mb-1">Q3 紧急不重要</div>
                                        <p className="text-slate-600 dark:text-gray-300 leading-relaxed text-xs">
                                    ...
                                    <div className="p-3 rounded-xl bg-yellow-50 dark:bg-yellow-500/10 border border-yellow-100 dark:border-yellow-500/20">
                                        <div className="font-bold text-yellow-600 dark:text-yellow-400 mb-1">Q4 不重要不紧急</div>
                                        <p className="text-slate-600 dark:text-gray-300 leading-relaxed text-xs">
                            ...
                            <section className="space-y-4">
                                ...
                                <ul className="space-y-4 text-sm text-slate-600 dark:text-gray-300">
                                    <li className="flex gap-3">
                                        <div className="min-w-[24px] h-6 flex items-center justify-center bg-slate-100 dark:bg-white/10 rounded-full text-xs font-bold shrink-0">1</div>
                                        <div>
                                            <span className="font-bold text-slate-800 dark:text-white block mb-1">新建任务</span>
                                            点击任意象限的空白处，或点击左上角的“新建任务”按钮。支持设置截止日期、添加子任务和备注。
                                        </div>
                                    </li>
                                    <li className="flex gap-3">
                                        <div className="min-w-[24px] h-6 flex items-center justify-center bg-slate-100 dark:bg-white/10 rounded-full text-xs font-bold shrink-0">2</div>
                                        <div>
                                            <span className="font-bold text-slate-800 dark:text-white block mb-1">闪念库</span>
                                            页面中央的输入框用于捕捉稍纵即逝的灵感。输入内容并回车，它将作为“闪念”存储，并在中央氛围流中循环展示。你可以在闪念库中查看所有记录，或将其转化为正式任务。
                                        </div>
                                    </li>
                                    <li className="flex gap-3">
                                        <div className="min-w-[24px] h-6 flex items-center justify-center bg-slate-100 dark:bg-white/10 rounded-full text-xs font-bold shrink-0">3</div>
                                        <div>
                                            <span className="font-bold text-slate-800 dark:text-white block mb-1">进度与完成</span>
                                            任务卡片上的进度条支持点击，可直接调整进度（20% - 100%）。点击圆圈图标可直接完成任务，并触发庆祝特效。
                                        </div>
                                    </li>
                                </ul>
                            </section>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <section className="space-y-2">
                                    ...
                                    <p className="text-xs text-slate-500 dark:text-gray-400 leading-relaxed">
                                        支持拖拽任务在象限间移动。移动端适配了滑动切换象限的手势操作。
                                    </p>
                                </section>
                                ...
                                <section className="space-y-2">
                                    ...
                                    <p className="text-xs text-slate-500 dark:text-gray-400 leading-relaxed">
                                        点击“历史记录”查看过往。支持列表视图和日历视图。日历视图下，每天的完成情况会通过红/绿点直观展示。
                                    </p>
                                </section>
                            </div>
                        </div>
